...
@section('title', 'Login - Comginsoon')
...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-brand-600 to-brand-700 px-8 py-8 text-center">
            ...
            <p class="text-brand-100 text-sm mt-1">Sign in to your Comginsoon account</p>
        </div>
        ...
        <div class="p-8">
            <form method="POST" action="{{ route('login') }}" class="space-y-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-sm font-medium text-brand-600 hover:text-brand-700 transition-colors">Forgot password?</a>
                    @endif
                </div>
            ...
            <p class="text-center text-sm text-gray-500">
                ...
                <a href="{{ route('register') }}" class="font-semibold text-brand-600 hover:text-brand-700 transition-colors">Create account</a>
            </p>
        </div>
    </div>
